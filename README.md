...
**Version:** 2.4.0 &nbsp;|&nbsp; **Author:** Alexander Skrypek &nbsp;|&nbsp; **License:** Apache 2.0
...
| Inductance & Stored Energy | Self/mutual inductance matrix and total magnetic stored energy for the coil system |
...
| Project Tabs | Multiple coil projects open side by side in a tabbed workspace |
...
| Version | Highlights |
|---|---|
| **2.4.0** | Project-tab workspace; inductance & stored-energy readout; verified inductance kernel (FastHenry Hoer-Love self-partial + Grover mutual) |
| 2.3.0 | Bug fixes and UI improvements |
